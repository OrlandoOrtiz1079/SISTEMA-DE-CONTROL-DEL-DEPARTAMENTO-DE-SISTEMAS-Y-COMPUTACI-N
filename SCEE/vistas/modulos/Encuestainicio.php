        ...
        <div class="py-5 col-12 col-sm col-lg-6 mx-auto">
            <form class="bg-white py-3 px-4" action="Preguntas" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input onkeypress="return event.charCode > 47 && event.charCode < 58;" pattern="[0-9]{8}" maxlength="8" type="text" class="form-control" name="control" placeholder="Numero de control" autofocus required autocomplete="off">
                </div>
