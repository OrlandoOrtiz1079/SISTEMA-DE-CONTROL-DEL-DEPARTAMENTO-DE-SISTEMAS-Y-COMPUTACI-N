...
class modeloRegistro
{
    ...
    {
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nocontrol, alumno, laboratorio, fecha, hora, carrera) VALUES (:nocontrol, :alumno, :laboratorio, :fecha, :hora, :carrera)");
