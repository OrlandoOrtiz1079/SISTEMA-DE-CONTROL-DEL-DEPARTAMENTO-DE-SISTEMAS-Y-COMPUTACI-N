                ...
                <div class="horizontal-menu">
                    <nav>
                        <ul id="nav_menu">
                            ...
                            <li>
                                <a href="Inicio"><i class="fas fa-file fa-lg fa-2x" style="color: #845ef7;"></i><span><strong>Constancias</strong></span></a>
                            </li>
                            <li>
                                <a href="Docentes"><i class="fas fa-chalkboard-teacher fa-lg fa-2x" style="color: #845ef7;"></i><span><strong>Docentes</strong></span></a>
                            </li>
                            <li>
                                <a href="Jerarquia"><i class="fas fa-sitemap fa-lg fa-2x" style="color: #845ef7;"></i><span><strong>Jerarquia</strong></span></a>
                            </li>
                            <li>
