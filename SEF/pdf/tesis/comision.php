...
$pdf->Ln(3);
$pdf->Cell(19);
$pdf->MultiCell(153, 4, utf8_decode("en " . $traslado . " para asistir al " . $lugar . " en donde se " . $objetivo . "  misma que se llevará a cabo el próximo " . $diasem . " " . $dia . " de " . $mes2 . " de " . $año . " en punto de las " . $hora . " horas."), 0, 'J', 1);
