 ...
 <div class="footer">
     <div class="social_block">
         ...
         <div class="hidden-sm hidden-xs">
             <p style="margin-left: 10px;">Síguenos en nuestras redes sociales</p>
         </div>
         <ul>
             <li class="facebook">
                 <a href="https://www.facebook.com/TECNM.campus.Iguala" target="_blank">Facebook</a>
             </li>
             <li class="twitter">
                 <a href="https://twitter.com/TecNM_Iguala" target="_blank">Twitter </a>
             </li>
             <li class="youtube">
                 <a href="https://www.youtube.com/channel/UCpSJGS6p28O5qrQjQGxlE8g" target="_blank">YouTube </a>
             </li>
         </ul>
     </div>
     <div>
                 ...
                 <center>
                     ...
                     <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="height: 100%; display: grid; align-items: center">
                         <a href="https://www.gob.mx/" target="_blank">
                             <img class="img-fluid" style="max-height: 60px" src="https://framework-gb.cdn.gob.mx/landing/img/logoheader.svg" />
                         </a>
                     </div>

                     <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="height: 100%; display: grid; align-items: center">
                         <a href="https://www.gob.mx/sep" target="_blank">
                             <img class="img-fluid" style="max-height: 60px" src="../assets/images/logos/educacion.png" />
                         </a>
                     </div>
         ...
         <div style="background-size: auto; height: 40px; background-image: url(https://framework-gb.cdn.gob.mx/landing/img/pleca.svg) !important;"></div>
     </div>
     < </div>