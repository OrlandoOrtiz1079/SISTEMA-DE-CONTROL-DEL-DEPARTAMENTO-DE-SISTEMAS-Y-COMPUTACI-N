...
class ControladorJerarquia
{
    ...
    public static function ctrMostrarDocentesJerarquia3($item, $valor)
    {
        $tabla = "datos_alumnos";
        $respuesta = ModeloDocentesJerarquia::MdlMostrarDocentesJerarquia3($tabla, $item, $valor);
        return $respuesta;
    }


    public static function ctrMostrarDocentesJerarquia2($tabla, $item)
    {
        $respuesta = ModeloDocentesJerarquia::MdlMostrarDocentesJerarquia2($tabla, $item);
        return $respuesta;
    }

    

    public static function ctrMostrarDocentesDirectorio($tabla, $item)
    {
        $respuesta = ModeloDocentesJerarquia::MdlMostrarDocentesDirectorio($tabla, $item);
        return $respuesta;
    }
    /*=============================================
        AGREGAR JERARQUIA
