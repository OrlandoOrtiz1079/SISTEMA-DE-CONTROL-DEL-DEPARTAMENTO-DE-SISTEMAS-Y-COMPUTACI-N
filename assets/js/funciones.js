...
function espera() {
   bootbox.dialog({ 
            size: 'small',
            message: "<p><img src='/plantillas/tecnm/logos/loading.gif' width='50' height='50'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Generando Solicitud...</p>", 
        });
   return true;
}

function fileinput() {
  var id = $("#useralumno-alu_matricula").val();
  $.get('/user-alumno/fileinput', {"id":id})
  .done(function(fileinput) {
      bootbox.dialog({ 
          size: 'medium',
          message: fileinput,
          onEscape : function() {
...
function fileinputborrar() {
  var id = $("#useralumno-alu_matricula").val();
  $.post('/user-alumno/fileinputborrar?id='+id)
    .done(function(d) {
       bootbox.dialog({ 
            size: 'small',
            message: d, 
...
function asignacion(ticket) {
  ...
  bootbox.dialog({ 
            size: 'small',
            message: "<p><img src='/plantillas/tecnm/logos/loading.gif' width='50' height='50'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Asignando Técnico...</p>", 
        });
  if(tecnico !== '') {
