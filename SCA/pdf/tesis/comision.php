...
if (isset($_SESSION['iniciarSesion']) && $_SESSION['iniciarSesion'] == "ok") {
    ...
    $text2 = "Por medio del presente, me permito enviar a usted el <JURADO> que fungirá en el Acto de Titulación, del <C. " . mb_strtoupper($nombre) . ",> que presenta su <TITULACIÓN INTEGRAL \"TESIS PROFESIONAL\">, el día <" . mb_strtoupper($fechaTitulacion) . "> del año en curso, a las <" . $hora . " hrs.>, a través de la platafoma <ZOOM.>";
    // if ($_GET['defiende'] == 'si') {
...
'), 1, 'C');
    ...
    $text2 = "Por medio del presente, me permito hacer de su conocimiento que ha sido comisionado (a) para fungir como <PRESIDENTE(A)>, en el Acto de Recepción Profesional de él (la) <C." . $res['nombre'] . ">, que realiza su <TITULACIÓN INTEGRAL \"TESIS PROFESIONAL\">, el día <" . utf8_decode(mb_strtoupper($_GET['fechaT'])) . " del año en curso>,  a las <" . $_GET['horaT'] . " HRS.>, a través de la plataforma <ZOOM.>";
    // if ($_GET['defiende'] == 'si') {
    //     $pdf->WriteText(utf8_decode($text1));
    // } else {
        $pdf->WriteText(utf8_decode($text2));
...
Mujeres: Vestir de manera formal (traje sastre o de acuerdo al evento).'), 1, 'L');
    ...
    $text2 = "Por medio del presente, me permito hacer de su conocimiento que ha sido comisionado (a) para fungir como <SECRETARIO(A)>, en el Acto de Recepción Profesional de él (la) <C." . $res['nombre'] . ">, que realiza su <TITULACIÓN INTEGRAL \"TESIS PROFESIONAL\">, el día <" . utf8_decode(mb_strtoupper($_GET['fechaT'])) . " del año en curso>,  a las <" . $_GET['horaT'] . " HRS.>, a través de la plataforma <ZOOM.>";
    // if ($_GET['defiende'] == 'si') {
    //     $pdf->WriteText(utf8_decode($text1));
    // } else {
        $pdf->WriteText(utf8_decode($text2));
...
Mujeres: Vestir de manera formal (traje sastre o de acuerdo al evento).'), 1, 'L');
    ...
    $text2 = "Por medio del presente, me permito hacer de su conocimiento que ha sido comisionado (a) para fungir como <VOCAL>, en el Acto de Recepción Profesional de él (la) <C." . $res['nombre'] . ">, que realiza su <TITULACIÓN INTEGRAL \"TESIS PROFESIONAL\">, el día <" . utf8_decode(mb_strtoupper($_GET['fechaT'])) . " del año en curso>,  a las <" . $_GET['horaT'] . " HRS.>, a través de la plataforma <ZOOM.>";
    // if ($_GET['defiende'] == 'si') {
    //     $pdf->WriteText(utf8_decode($text1));
    // } else {
        $pdf->WriteText(utf8_decode($text2));
...
Mujeres: Vestir de manera formal (traje sastre o de acuerdo al evento).'), 1, 'L');
    ...
    $text2 = "Por medio del presente, me permito hacer de su conocimiento que ha sido comisionado (a) para fungir como <VOCAL SUPLENTE>, en el Acto de Recepción Profesional de él (la) <C." . $res['nombre'] . ">, que realiza su <TITULACIÓN INTEGRAL \"TESIS PROFESIONAL\">, el día <" . utf8_decode(mb_strtoupper($_GET['fechaT'])) . " del año en curso>,  a las <" . $_GET['horaT'] . " HRS.>, a través de la plataforma <ZOOM.>";
    // if ($_GET['defiende'] == 'si') {
    //     $pdf->WriteText(utf8_decode($text1));
    // } else {
        $pdf->WriteText(utf8_decode($text2));
